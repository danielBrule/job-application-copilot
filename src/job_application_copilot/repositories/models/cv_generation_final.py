"""Private persisted structured output from CV-generation stage three."""
...
class CvGenerationFinal(Base):
    """One validated final CV retained for one logical CV-generation task."""

    __tablename__ = "cv_generation_finals"
    __table_args__ = (UniqueConstraint("task_id", name="uq_cv_generation_finals_task"),)
