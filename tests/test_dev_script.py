...
def test_database_target_is_idempotent(
    ...
    assert "Current revision: 0003_create_reference_assets_table" in second_result.stdout
    assert "Target revision: 0003_create_reference_assets_table" in second_result.stdout
