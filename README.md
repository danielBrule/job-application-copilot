...
GitHub Actions. The Streamlit application supports manual job entry and editing through an
initial sortable, selectable Jobs dashboard; background-run and settings controls are delivered
by later tickets.
